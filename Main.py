...
class Game:
    ...
    def load(self):
        ...
        ui_folder = path.join(game_folder, 'UI')
        self.map = TiledMap(path.join(map_folder, 'BOSS ROOM.tmx'))
        ...
        self.alerted = p.image.load(path.join(ui_folder, ALERT)).convert_alpha()
